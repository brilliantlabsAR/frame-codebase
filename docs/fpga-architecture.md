...
| 0x26    | `CAMERA_COMPRESSION_FACTOR` | Sets the compression factor of the saved image.<br>**Write: `compression_factor[3:0]`**<br>`compressopn_factor` is a signed 2's complement number. The table below shows QF equivalents and the actual quantization table scaling factors.<br>-8: QF = 99.8, scale = 2<sup>-8</sup><br>-7: QF = 99.6,  scale = 2<sup>-7</sup><br>-6: QF = 99.2,  scale = 2<sup>-6</sup><br>-5: QF = 98.4,  scale = 2<sup>-5</sup><br>-4: QF = 96.9,  scale = 2<sup>-4</sup><br>-3: QF = 93.8,  scale = 2<sup>-3</sup><br>-2: QF = 87.5,  scale = 2<sup>-2</sup><br>-1: QF = 75.0,  scale = 2<sup>-1</sup><br>0: QF = 50.0,  scale = 2<sup>0</sup><br>1: QF = 25.0,  scale = 2<sup>1</sup><br>2: QF = 12.5,  scale = 2<sup>2</sup><br>3: QF = 6.2,  scale = 2<sup>3</sup><br>4: QF = 3.1,  scale = 2<sup>4</sup><br>5: QF = 1.6,  scale = 2<sup>5</sup><br>6: QF = 0.8,  scale = 2<sup>6</sup><br>7: QF = 0.4,  scale = 2<sup>7</sup>`
| 0x30    | `COMPRESSION_STATUS`        | Status of JPEG core.<br>**Read: `image_complete[0:0]`**<br>**`Bit 0: Returns 1 when compression completed. Read twice before proceeding with readout of the ECS.`**
| 0x31    | `COMPRESSED_BYTES_MINUS_4`  | Returns size in bytes minus 4 of the ECS (= Entropy Coded Segment, that is, everything after the SOS marker and header, and before the EOS marker). Add 4 to get the actual size of the ECS. <br>**Read: `compressed_bytes_minus_4[15:0] (LSB first)`**
