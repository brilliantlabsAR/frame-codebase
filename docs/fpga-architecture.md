...
| 0x31    | `COMPRESSED_BYTES`          | Returns size in bytes of ECS segment (that is, everything after the SOS marker and header, and before the EOS marker).<br>**Read: `compressed_bytes[20:0]`**
