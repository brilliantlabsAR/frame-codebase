...
| 0x18    | `GRAPHICS_BUFFER_STATUS`     | Status of graphics buffer.<br>**Read: `status[2:0]`**<br>`status[0]`: Current buffer<br>`status[1]`: Switch buffer pending<br>`status[2]`: Clear buffer pending
...
| 0x26    | `COMPRESSION_QUALITY_FACTOR` | Sets the Quality Factor (QF) of the saved JPEG image. High values are higher quality but bigger size.<br>**Write: `quality_factor[2:0]`**<br>`0x0` = QF50 (default) <br>`0x1` = QF100<br>`0x2` = QF10<br>`0x3` = QF25<br>`0x4` = QF20<br>`0x5` = QF30<br>`0x6` = QF40<br>`0x7` = QF80<br>
