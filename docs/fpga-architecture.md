...
| 0x26    | `CAMERA_QUALITY_FACTOR` | Sets the Quality Factor (QF) of the saved JPEG image. High values are higher quality but bigger size.<br>**Write: `quality_factor[2:0]`**<br>`0x0` = QF50 (default) <br>`0x1` = QF100<br>`0x2` = QF10<br>`0x3` = QF25<br>`0x4` = QF20<br>`0x5` = QF30<br>`0x6` = QF40<br>`0x7` = QF80<br>
