...
| 0x31    | `COMPRESSED_BYTES`          | Returns size in bytes of ECS (that is, everything after the SOS marker and header, and before the EOS marker).<br>**Read: `compressed_bytes[15:0] (LSB first)`**
