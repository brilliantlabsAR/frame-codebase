...
module pll_sim_ip (clki_i, 
    ...
    output clkos5_o ; 
    output lock_o ; 
    pll_sim_ip_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .FRAC_N_EN(0),
            .FBK_MODE("CLKOS5"),
            .FBCLK_DIVIDER_ACTUAL_STR("8"),
            .SSC_N_CODE_STR("0b000001000"),
...
// Module : lscc_pll
//==========================================================================
module pll_sim_ip_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                pll_sim_ip_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module pll_sim_ip_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
