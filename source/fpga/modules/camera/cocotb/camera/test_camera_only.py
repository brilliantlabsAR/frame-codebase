...
class Tester(SPITransactor):
    def __init__(self, dut, img_file='baboon.bmp'):
        ...
        # self.y, self.x = 100, 100  # crop full sensor size
    ...
    async def initialize_encoder(self):
        ...
        self.jpeg_sel = 1
        await self.spi_write(0x30, 0x6)
        # wait 16 cycles
        await ClockCycles(self.dut.clock_spi_in, 16)
        await self.spi_write(0x30, 0x0)
        await ClockCycles(self.dut.clock_spi_in, 16)
...
async def dct_test(dut):
    ...
    test_image = '../../testbenches/test_image_bayered.png'
